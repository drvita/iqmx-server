...
DO $$ BEGIN
 ALTER TABLE "messenger_credentials" ADD CONSTRAINT "messenger_credentials_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "crm"."organization"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
