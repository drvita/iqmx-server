...
/**
 * Consulta si la agenda está habilitada para una organización específica.
 * Si se especifica organizationId, consulta en crm.organization_settings.
 * Si no se especifica o en fallback, consulta la variable de entorno.
 */
