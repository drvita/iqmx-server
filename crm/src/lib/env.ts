...
const envSchema = z.object({
  ...
  CENTRAL_PROVISION_KEY: z.string().optional(),
...
/** true si hay proveedor de IA configurado (token en la organización o en entorno). */
export function isAiConfigured(hasKey?: boolean | { aiApiKeyEncrypted?: string | null }): boolean {
  if (typeof hasKey === "boolean") return hasKey;
  if (hasKey && "aiApiKeyEncrypted" in hasKey) return Boolean(hasKey.aiApiKeyEncrypted);
