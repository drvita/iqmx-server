    ...
    <div className="max-w-2xl space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Personaliza la identidad de tu CRM: asigna el nombre de tu empresa,
            moneda comercial y color representativo. Se reflejan en toda la plataforma y en el inicio de sesión.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-5">
          <div className="space-y-1.5">
            <Label htmlFor="brand-name">Nombre de la Empresa / CRM</Label>
            <Input
              id="brand-name"
              maxLength={30}
              value={name}
              onChange={(e) => setName(e.target.value)}
              placeholder="Ej: IQMX, IQISSMexico o Mi Empresa"
              className="max-w-xs"
            />
          </div>
